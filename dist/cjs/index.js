...
const ButtonStyled = Qe.button `
  ...
  &:disabled {
    ...
    background-color: ${({ customTheme }) => (customTheme === null || customTheme === void 0 ? void 0 : customTheme.includes('primary')) ? colors.grayscale[5] : colors.white[100]};
  }
`;

const Button = ({ children, type = 'button', size = 'medium', customTheme = 'primary', handleClick, disabled = false, className }) => (React.createElement(ButtonStyled, { type: type, size: size, customTheme: customTheme, onClick: handleClick, disabled: disabled, className: className }, children));
